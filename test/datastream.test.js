...
describe("DataStream", () => {
	...
	describe("number", () => {
		...
		it("should throw error with undefined", () => {
			expect(() => ds.writeNumberAsString()).to.throw(
				Error,
		...
		it("should throw error with string", () => {
			expect(() => ds.writeNumberAsString("123")).to.throw(
				Error,
				"Value must be a number"
			);
		});
	...
	describe("string", () => {
		...
		it("should throw error with undefined", () => {
			expect(() => ds.writeString()).to.throw(
				Error,
		...
		it("should throw error with number", () => {
			expect(() => ds.writeString(123)).to.throw(
				Error,
				"Value must be a string"
			);
		});
	...
	describe("boolean", () => {
		...
		it("should throw error with undefined", () => {
			expect(() => ds.writeBoolean()).to.throw(
				Error,
		...
		it("should throw error with number", () => {
			expect(() => ds.writeBoolean(123)).to.throw(
				Error,
				"Value must be a boolean"
			);
		});
	...
	describe("function", () => {
		...
		it("should write function with body", () => {
			expect(
				ds.writeFunction(function () {
					return 228;
				})
			).to.not.throw;
			expect(
				ds.writeFunction(function (a) {
					return a;
				})
			).to.not.throw;
			expect(
				ds.writeFunction(function (a, b) {
					return a + b;
				})
			).to.not.throw;
		});
		...
		it("should throw error with undefined", () => {
			expect(() => ds.writeFunction()).to.throw(
				Error,
		...
		it("should throw error with number", () => {
			expect(() => ds.writeFunction(123)).to.throw(
				Error,
				"Value must be a function"
			);
		});
	...
	describe("object", () => {
		...
		const isMale = true;
		const func = () => {
			return `${this.surname} ${this.name} is ${this.year} old and ${
		...
		it("should read object with strings", () => {
			expect(JSON.stringify(ds.readObject())).to.equal(
		...
		it("shoud write full object", () => {
			expect(ds.writeObject({ name, surname, year, func, isMale })).to.not
				.throw;
		});

		it("shoud write full object", () => {
			expect(JSON.stringify(ds.readObject())).to.equal(
				JSON.stringify({ name, surname, year, isMale, func })
			);
		});

		it("should throw error with undefined", () => {
			expect(() => ds.writeObject()).to.throw(
				Error,
		...
		it("should throw error with number", () => {
			expect(() => ds.writeObject(123)).to.throw(
				Error,
				"Value must be a object"
			);
		});
		...
		it("should throw error with null", () => {
			expect(() => ds.writeObject(null)).to.throw(
				Error,
				"Object cannot be a null"
			);
		});
	});
});
